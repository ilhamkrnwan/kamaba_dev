<template>
  ...
  >
    ...
    <div class="relative aspect-square overflow-hidden bg-gradient-to-br from-primary/20 to-secondary/20">
      ...
      <div
        v-else
        class="flex h-full w-full items-center justify-center text-6xl font-bold text-primary/20"
      >
        {{ initials }}
      </div>
    ...
    <div class="p-6">
      ...
      <!-- Skills/Tech stack -->
      <div v-if="skills && skills.length > 0" class="mb-4 flex flex-wrap gap-2">
        <span
      ...
      <!-- Social links -->
      <div v-if="socials" class="flex gap-3">
        <a
          v-if="socials.github"
          :href="socials.github"
          target="_blank"
